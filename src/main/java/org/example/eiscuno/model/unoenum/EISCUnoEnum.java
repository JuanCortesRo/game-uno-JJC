...
public enum EISCUnoEnum {
    ...
    BLUE_TWO_WILD_DRAW("cards-uno/2_wild_draw_blue.png"),
    GREEN_TWO_WILD_DRAW("cards-uno/2_wild_draw_green.png"),
    YELLOW_TWO_WILD_DRAW("cards-uno/2_wild_draw_yellow.png"),
    ...
    YELLOW_RESERVE("cards-uno/reserve_yellow.png"),
    GREEN_RESERVE("cards-uno/reserve_green.png"),
    RED_RESERVE("cards-uno/reserve_red.png"),
